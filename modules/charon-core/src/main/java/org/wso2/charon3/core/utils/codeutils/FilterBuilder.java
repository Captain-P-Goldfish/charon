...
public class FilterBuilder implements Serializable {
     ...
     * @param operation       the operation if the value is equals, contains etc.
     * @param value           the value to compare
     * @param concatenation   the concatenation if the filter needs one yet
     */
     ...
     * <br>
     * if the attribute is from the user or group core schema the simple attribute names will be used like
     * "emails.type" or "userName". But if the attribute comes from an extension - discovered by the fact
     * that the attribute uri does not start with one of the core schema uris - the full attribute uri is
     * used as field-name
     */
